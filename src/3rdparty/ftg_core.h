...
/* resolve _DEBUG/DEBUG ambiguity across common build environments */
#ifndef _DEBUG
#  ifdef DEBUG
#    define _DEBUG
#  endif
...
#else
#  if FTG_BITS == 64 && !defined(__APPLE__)
#    define FTG_SPEC_INT64   "li"
#    define FTG_SPEC_UINT64  "lu"
#  elif FTG_BITS == 32 || defined(__APPLE__)
...
define FTG_ENABLE_ASSERT or _DEBUG to prevent asserts from being noops
...
#if defined(FTG_ENABLE_ASSERT) || defined(_DEBUG) || defined(FTGT_TESTS_ENABLED)
...
#  define FTG_STOPWATCH_DECL(sw)           struct ftg_stopwatch_s sw
